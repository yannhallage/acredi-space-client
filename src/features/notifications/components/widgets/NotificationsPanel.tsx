...
import { Avatar, Card, Icon, type IconName } from '../../../../shared/ui';
    ...
    <>
      <header className="page-header compact">
        <div>
          ...
          <p>{unread.length} notifications non lues sur {notifications.length}.</p>
        </div>
        ...
        <aside className="notification-side">
          ...
          <Card title="Resume">
            <dl className="details-list">
              ...
              <div><dt>Fichiers</dt><dd>{notifications.filter((item) => item.type === 'file').length}</dd></div>
              <div><dt>Messages</dt><dd>{notifications.filter((item) => item.type === 'message').length}</dd></div>
              <div><dt>Reunions</dt><dd>{notifications.filter((item) => item.type === 'meeting').length}</dd></div>
            </dl>
          </Card>
        </aside>
      </section>
